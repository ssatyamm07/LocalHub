...
<head>
	<title>Local Hub || Home Page</title>
...
<body>
	...
	<div class="theme-wrap clearfix">
				...
				<div class="revolution-slider tx-center">
					<ul><!-- SLIDE -->
						<li data-transition="slideright" data-slotamount="5" data-masterspeed="1000">
							<!-- MAIN IMAGE -->
							<img src="images/banner5.jpg" alt="item slide">
						</li>
					</ul>
				</div>
			</div>
		...
		<section id="worker-registration" class="padding-top-20 padding-bottom-40">
			<div class="container">
				<div class="section-title-wrap margin-bottom-50">
					<h4>Looking for Work Opportunities?</h4>
				...
				<div class="text-center">
					<a href="worker.php" class="btn btn-primary btn-lg">Click Here to Register as a Worker</a>
				</div>
			</div>
		</section>
